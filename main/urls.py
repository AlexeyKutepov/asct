...
urlpatterns = patterns('',
        ...
        url(r'^get/test/list/by/journal/$', views.get_test_list_by_journal),

        url(r'^create/new/company/$', views.create_new_company, name="create_new_company"),
        url(r'^edit/company/$', views.edit_company, name="edit_company"),
        url(r'^add/department/$', views.add_department, name="add_department"),
        url(r'^department/settings/(?P<id>\d+)/$', views.department_settings, name="department_settings"),
        url(r'^delete/department/(?P<id>\d+)/$', views.delete_department, name="delete_department"),
        ...
        url(r'^edit/scheduled/theme/(?P<id>\d+)/$', views.edit_scheduled_theme, name="edit_scheduled_theme"),
        ...
        url(r'^stop/learning/theme/(?P<id>\d+)/$', views.stop_learning_theme, name="stop_learning_theme"),
        url(r'^sub/theme/in/work/(?P<id>\d+)/$', views.sub_theme_in_work, name="sub_theme_in_work"),
        url(r'^stop/learning/sub/theme/(?P<id>\d+)/$', views.stop_learning_sub_theme, name="stop_learning_sub_theme"),
        ...
        url(r'^manage/files/(?P<id>\d+)/$', views.manage_files, name="manage_files"),
        ...
        url(r'^departments/and/positions/$', views.departments_and_positions, name="departments_and_positions"),
)